...
function lvim.load_plugin_syntax()
	local plugin_syntax = {
		...
		GitSignsAdd = { fg = lvim.color_add, bg = lvim.bg_03 },
		GitSignsChange = { fg = lvim.color_change, bg = lvim.bg_03 },
		GitSignsDelete = { fg = lvim.color_delete, bg = lvim.bg_03 },
		GitSignsAddNr = { fg = lvim.color_add, bg = lvim.bg_03 },
		GitSignsChangeNr = { fg = lvim.color_change, bg = lvim.bg_03 },
		GitSignsDeleteNr = { fg = lvim.color_delete, bg = lvim.bg_03 },
		GitSignsAddLn = { fg = lvim.color_add, bg = lvim.bg_03 },
		GitSignsChangeLn = { fg = lvim.color_change, bg = lvim.bg_03 },
		GitSignsDeleteLn = { fg = lvim.color_delete, bg = lvim.bg_03 },
		...
		DiagnosticSignError = { fg = lvim.color_error, bg = lvim.bg_03 },
		DiagnosticSignWarn = { fg = lvim.color_warning, bg = lvim.bg_03 },
		DiagnosticSignInfo = { fg = lvim.color_info, bg = lvim.bg_03 },
		DiagnosticSignHint = { fg = lvim.color_info, bg = lvim.bg_03 },
		DiagnosticError = { fg = lvim.color_error, bg = lvim.bg_03 },
		DiagnosticWarn = { fg = lvim.color_warning, bg = lvim.bg_03 },
		DiagnosticInfo = { fg = lvim.color_info, bg = lvim.bg_03 },
		DiagnosticHint = { fg = lvim.color_info, bg = lvim.bg_03 },
		...
		HopNextKey1 = { fg = lvim.color_8, style = "underline" },
		HopNextKey2 = { fg = lvim.color_10, style = "underline" },
